...
async def help(bot, message):
  await message.reply_photo("https://telegra.ph/file/1247be6a5306b107a460f.jpg",caption=helps_msg,reply_markup=HelpBack_Btn)


DATABASE_URI=DATABASE_URI
database = Database(DATABASE_URI, "Emo_Bot") 
...
╔═════════════════════════════════════════════╗
   ...
   **Emo App Store Bot Users**  🏅`{countb}`
╚═════════════════════════════════════════════╝
"""
